...
function Snippets() {
    return (
        <div className="bg-white-100 p-4 rounded-lg shadow-xl m-4">
            <div className="text-lg font-semibold">My Snippets</div>
            <table className="p-4 min-w-full text-center border border-gray-200 rounded-lg shadow-lg mr-4 mt-4">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="p-2">This is a description of snippet 1.</td>
                        <td className="p-2">
